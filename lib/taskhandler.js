const { executeCommand, humanFileSize, setTerminalTitle } = require("./misc");
        ...
        if (ffmpeg_result.code !== 0) {
            ...
            setTimeout(() => {
                ...
                try {
                    ...
                    fs.appendFileSync('error.txt', `${task.split('.')[0]}: Error during IO. File deletion or renaming failed. FIX MANUALY!\n`);
                }
            }, 15 * 1000);
        }
